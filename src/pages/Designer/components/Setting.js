...
import { Menu, Card, Form, Input, Layout, Select, InputNumber, Radio, Checkbox, Tooltip, Cascader } from "antd";
import { InfoCircleOutlined, ControlOutlined, AlignLeftOutlined, AlignCenterOutlined, AlignRightOutlined, BoldOutlined, ItalicOutlined, ArrowsAltOutlined } from "@ant-design/icons";
    ...
    return <>
        <Sider theme="light" width={300} trigger={null} collapsible collapsed={false}>
            <Card size="small" title="属性" bodyStyle={{ height: "calc(100vh - 104px)" }} >
                {props.controlElement && props.controlAttrs
                    ...
                    >
                        ...
                        <Form.Item name="color" label="颜色" style={{ marginBottom: 2 }}>
                            <ColorSelect onChange={v => props.controlElement.style.setProperty("color", v, "important")} />
                        </Form.Item>
                        ...
                        {props.macroControlsConfig.find(c => c.name == props.controlAttrs.controlType)?.configComponent}
                        {/* 级联选择器 */}
                ...
                {props.controlElement && props.controlAttrs.name.split("_")[0] == "detailTable" ? <Form
                    ref={formRef}
                    size="small"
                    labelCol={{ span: 6 }}
                    wrapperCol={{ span: 18 }}
                        ...
                        <Radio.Group
                            ...
                            onChange={(e) => {
                                if (e.target.value) {
                                    ...
                                    //再设置当前行
                                    props.controlAttrs.fieldTR.setAttribute("detail-field", true);
                                }
                                else props.controlAttrs.fieldTR.removeAttribute("detail-field");
                            }}
                        />
                    </Form.Item> : null}
                </Form> : null}
                {props.controlElement && props.controlAttrs.name.split("_")[0] == "image" ? <Form
                    ref={formRef}
                    size="small"
                    labelCol={{ span: 6 }}
                    wrapperCol={{ span: 18 }}
        ...
        <Sider collapsedWidth={40} theme="light" trigger={null} collapsible collapsed={true} style={{ height: "calc(100vh - 64px)" }}>
